...
from .routes import auth, circuits, machines, power_electronics, ai, reports, power_systems, control_systems
...
app.include_router(control_systems.router, prefix=settings.API_V1_STR)
